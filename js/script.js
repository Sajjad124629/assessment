var mainVideo = document.querySelector('.main-video'); //select main video
var mainImage = document.querySelector('.main-image'); //select main image
let videoList = document.querySelectorAll(".video-list-container .list"); //select video list
let imageSRC = document.querySelector('.main-image');
// click video list for play another video
